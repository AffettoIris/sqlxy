...
<body>
    <?php include('../../static/common/LoginRegister/header.html'); ?>
    <!-- 登录页面 -->
    ...
    <div class="login_area-fa clearfix">
        <section class="login_area">
            ...
            <div class="login_bd">
                <form action="../../php/LoginRegister/TeaLogJudge.php" class="login_form" method="post">
                    <ul>
                        <li>
                            <label for="studentID"> 教师名</label> <em class="number-error"><?php echo $number_error ?></em>
                            <br>
                            <input type="text" name="teacherNumber" id="studentID" class="inp" required="required" autocomplete="autocomplete">
                        </li>
                        <li>
                            <label for="studentPwd"> 密码</label> <br> <em class="number-error"><?php echo $pwd_error ?></em>
                            <input type="password" name="teacherPwd" id="studentPwd" class="inp" required="required" autocomplete="autocomplete">
    ...
    <script src="../../static/common/js/舞动的彩带背景.js"></script>
</body>
