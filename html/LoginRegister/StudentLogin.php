...
<body>
    ...
    <div class="login_area-fa clearfix">
        <section class="login_area">
            ...
            <div class="login_bd">
                <form action="../../php/LoginRegister/StuLogRegJudeg.php?choose=login" class="login_form" method="post">
                    <ul>
                        <li>
                            <label for="studentID"> 学号</label> <em class="number-error"><?php echo $number_error ?></em>
                            <br>
