    ...
    <div class="mask">
        <div class="question_info_fa w clearfix">
            ...
            <div class="question_info_right" id="question_info_right">
                <form action="IssueJudge.php" class="q_form" id="q_form" method="post">
                    <!-- 表单的第一块 -->
                    <div class="form_one">
                    ...
                    <!-- 表单的第二块 -->
                    <div class="form_two">
                        <textarea id="q_init" name="q_init" class="q_init" required style="line-height: 20px;height: 50vh;" placeholder="请老师在此输入create table和insert into values语句以搭建题目环境,输入至少需带有create table语句，否则无法正确评判答案！本题目仅支持在单表操作！"></textarea>
