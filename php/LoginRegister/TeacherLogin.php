...
<head>
    ...
    <script src="../../js/LoginRegister/TeacherLogin.js"></script>
</head>
...
<body>
    ...
    <div class="login_area-fa clearfix">
        <section class="login_area">
            ...
            <div class="login_bd">
                <form action="TeaLogJudge.php" class="login_form" method="post">
                    <ul>
                        <li>
                        ...
                        <li>
                            <label for="studentPwd"> 密码</label> <em class="number-error" id="tPwdError"><?php echo $pwd_error ?></em>
